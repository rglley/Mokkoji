  ...
  <div class="w-80 items-center m-5 flex flex-col gap-2 mb-16">
    ...
    <div id="box-shadow">
      <div class="flex flex-col justify-center">
        <a
          type="button"
          class="text-white bg-[#FEE500] hover:bg-[#FEE500]/50 focus:ring-4 focus:outline-none focus:ring-[#FEE500]/40 font-bold rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-4  w-[25lvw]"
