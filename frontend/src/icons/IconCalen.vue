  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      <g fill="none" fill-rule="evenodd" transform="translate(2 2)">
        ...
        <mask id="calendar-d" fill="#ffffff"><use xlink:href="#calendar-c"></use></mask>
        <use fill="#000000" fill-rule="nonzero" xlink:href="#calendar-c"></use>
