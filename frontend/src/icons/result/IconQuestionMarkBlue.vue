<template>
  <svg viewBox="0 0 24 24" height="2.5em" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
    <g id="SVGRepo_iconCarrier">
      <g clip-path="url(#4f80f0clip0_429_11043)">
        <circle
          cx="12"
          cy="11.9999"
          r="9"
      ...
      <defs>
        <clipPath id="clip0_429_11043"><rect width="24" height="24" fill="white"></rect></clipPath>
      </defs>
    </g>
  </svg>
</template>
