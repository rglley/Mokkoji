...
public class ResultServiceImpl implements ResultService {
    ...
    public void updateRollingpaper(Long resultId, RollingPaperReqDto rollingPaperReqDto) {
        ...
        Map<String, Long> backgroundNameToId = Map.of(
                "basic", 1L,
                "wedding", 2L,
                "school", 3L,
                "lunar", 4L,
        ...
        Map<String, Long> postitNameToId = Map.of(
                "rainbow", 1L,
                "green", 2L,
                "blue", 3L,
                "pink", 4L,
        ...
        Long bgId = backgroundNameToId.getOrDefault(backgroundName, rollingpaper.getBackgroundTemplate().getId());
        ...
        Long postitId = postitNameToId.getOrDefault(postitName, rollingpaper.getPostitTemplate().getId());
